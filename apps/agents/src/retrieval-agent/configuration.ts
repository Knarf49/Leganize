...
export const IndexConfigurationAnnotation = Annotation.Root({
   ...
   * Options are 'pinecone', 'mongodb', or 'chroma'.
   */
  retrieverProvider: Annotation<"pinecone" | "mongodb" | "chroma">,
...
export function ensureIndexConfiguration(
  ...
  >;
  return {
    userId: configurable.userId || "law", // Give a default user for shared docs
    embeddingModel:
