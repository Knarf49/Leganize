      ...
      {Object.entries(args).map(([k, v]) => {
        ...
        return (
          <div key={`args-${k}`} className="flex flex-col gap-1 items-start">
            <p className="text-sm leading-4.5 text-gray-600 text-wrap">
              {prettifyText(k)}:
            </p>
            <span className="text-[13px] leading-4.5 text-black bg-zinc-100 rounded-xl p-3 w-full max-w-full">
...
function ResponseComponent({
  ...
  return (
    <div className="flex flex-col gap-4 p-6 items-start w-full rounded-xl border border-gray-300">
...
function AcceptComponent({
  ...
  return (
    <div className="flex flex-col gap-4 items-start w-full p-6 rounded-lg border border-gray-300">
  ...
  return (
    <div className="flex flex-col gap-4 items-start w-full p-6 rounded-lg border border-gray-300">
      ...
      {Object.entries(editResponse.args.args).map(([k, v], idx) => {
        ...
        return (
          <div
            className="flex flex-col gap-1 items-start w-full h-full px-px"
